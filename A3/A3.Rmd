...
sales <-  c("sales_mil_log", # no flag for NA because there are none for sales_mil
            "d1_sales_mil_log_mod", "flag_missing_d1_sales_mil_log")
...
logitvars <- c(qualityvars, engvar, engvar2, engvar3, sales, hr, firm, interactions1, interactions2)

# random forest (no interactions, no modified features)
rfvars  <-  c("sales_mil", "d1_sales_mil_log", "flag_missing_d1_sales_mil_log", 
              "ceo_count", "labor_avg", "ind", "ind2_cat", rawvars, qualityvars, hr, firm)

# for logit LASSO
lassovars <- c("ceo_count", qualityvars, engvar, engvar2, engvar3, sales, hr, firm, interactions1, interactions2)
