...
summary_all_mods <- data.frame("Predictors" = unlist(nvars),
                               "Coefficients" = unlist(ncoeff),
...
pdp_n_acc <- pdp::partial(rf_model_p, pred.var = "age", pred.grid = distinct_(bisnode_holdout, "d1_sales_mil_log"), train = bisnode_work)
...
pdp_n_roomtype <- pdp::partial(rf_model_p, pred.var = "originmix", pred.grid = distinct_(bisnode_holdout, "originmix"), train = bisnode_work)
