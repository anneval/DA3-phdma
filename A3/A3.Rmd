...
are right-skewed. We favored percentage change primarily because of
...
```{r variable_relations_2, include=TRUE, echo=FALSE, fig.align='center', fig.height=2.5, fig.width=9}
...
```{r confusion table rf, include=TRUE, echo=FALSE}
###############################################
