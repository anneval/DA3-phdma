...
```{r pdp,echo=FALSE, include=FALSE, warning=F, eval=FALSE}
# pdp_n_acc_plot <- pdp_outputs$pdp_ceo_age %>%
#   autoplot( ) +
#   geom_point(color=color[1], size=2) +
#   geom_line(color=color[1], size=1) +
#   ylab("Growth") +
...
# pdp_n_roomtype_plot <- pdp_outputs$pdp_origin %>%
#   autoplot( ) +
#   geom_point(color=color[1], size=2) +
#   ylab("Predicted price") +
#   xlab("Room type") +
...
save(list = c("bisnode", "bisnode_work","bisnode_holdout","rf_model_p","rf_model_p_manu","rf_model_p_serv","rf_model_p_InteractLossPlot","rf_model_p_manu_InteractLossPlot","rf_model_p_serv_InteractLossPlot","rf_model_plots","rf_model_plots_grouped","rfvars","pdp_outputs","rf_pdp_plot"), file = "A3_dashboard.RData")
```
