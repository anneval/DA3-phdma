...
bisnode <- bisnode %>%
  mutate(ind2_cat = factor(case_when(
    ind2 >= 10 & ind2 < 34 ~ "manufacturing",
    ind2 >= 55 & ind2 < 57 ~ "services"
  )))
...
# missing values
# interactions (irrelevant ML?) yes See gabors file for logit interactions
