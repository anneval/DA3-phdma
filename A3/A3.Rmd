...
performs better in the services sector. Further
...
When comparing the above confusion matrix to the one below -- where we set the threshold
to the mean of predicted values (approx. 0.2) -- we see, as expected, 
how a lower threshold would lead to a higher probability of predicting high growth. 
...
The random forest performs better in the services sector. It exhibits a lower RMSE, a higher AUC and a lower expected loss. More differences can be seen in the respective confusion tables. First, manufacturing exhibits a higher prevalence of high growth firms (20.6% versus 17.6%).
