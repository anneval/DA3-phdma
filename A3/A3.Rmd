...
for (pred_var in rfvars) {
  # Generate PDP for the current predictor variable
  pdp_output <- partial(rf_model_p, pred.var = pred_var, pred.grid = distinct_(bisnode_holdout, pred_var), train = bisnode_work)
...
# do a loop over pred.var partial part and save ! 
rfvars
...
save(list = c("bisnode", "bisnode_work","bisnode_holdout","rf_model_p","rf_model_p_manu","rf_model_p_serv","rf_model_p_InteractLossPlot","rf_model_p_manu_InteractLossPlot","rf_model_p_serv_InteractLossPlot","rf_model_plots","rf_model_plots_grouped","rfvars"), file = "A3_dashboard.RData")
```
