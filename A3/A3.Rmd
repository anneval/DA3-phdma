...
for (pred_var in top10rfvar) {
  ...
  pdp_output <- pdp::partial(rf_model_p, pred.var = pred_var, pred.grid = distinct_(bisnode_holdout, pred_var), train = bisnode_work)
...
for (pred_var in top10rfvar) {
  # Generate PDP for the current predictor variable
  pdp_output <- pdp::partial(rf_model_p_manu, pred.var = pred_var, pred.grid = distinct_(manu_holdout, pred_var), train = manu_work)
...
for (pred_var in top10rfvar) {
  # Generate PDP for the current predictor variable
  pdp_output <- pdp::partial(rf_model_p_serv, pred.var = pred_var, pred.grid = distinct_(serv_holdout, pred_var), train = serv_work)
...
save(list = c("bisnode", "bisnode_work","bisnode_holdout","rf_model_p","rf_model_p_manu","rf_model_p_serv","rf_model_p_InteractLossPlot","rf_model_p_manu_InteractLossPlot","rf_model_p_serv_InteractLossPlot","rf_model_plots","rf_model_plots_grouped","rfvars","pdp_outputs","rf_pdp_plot","rf_pdp_plot_manu","rf_pdp_plot_serv"), file = "A3_dashboard.RData")
```
