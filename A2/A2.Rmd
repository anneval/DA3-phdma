...
vars_model_8 <- c("price_n", basic_lev,reviews,poly_lev,amenities,X1,X2)

modellev7 <- paste0(" ~ ",paste(c(basic_lev,reviews,poly_lev,X1,amenities),collapse = " + "))


formula <- paste0("price_n", modellev7)
